...
<div class="sidebar">
  ...
  <img src="images/verified-account (1).png" alt="Icon" style="width: 35px; height: 35px;"> โปรไฟล์
</a>

<a href="user.php" class="menu-item">
  <img src="images/seo.png" alt="Search Icon" style="width: 35px; height: 35px;"> จองห้องประชุม
</a>

<a href="all_booking_information.php" class="menu-item">
  <img src="images/time-management.png" alt="Calendar Check Icon" style="width: 35px; height: 35px;"> ประวัติการจองของฉัน
</a>

<a href="Review_Meeting_Room.php" class="menu-item">
  <img src="images/shooting-star.png" alt="Star Icon" style="width: 35px; height: 35px;"> รีวิวให้คะแนนห้องประชุม
</a>

<a href="room_reviews.php" class="menu-item active">
  <img src="images/chat-bubbles.png" alt="Comments Icon" style="width: 35px; height: 35px;"> ผลการรีวิวห้องประชุม
</a>
...
<p><i class="fas fa-tv" style="color: #CC66FF;"></i> จอ: <?= htmlspecialchars($room['screen']) ?>, 
   <i class="fas fa-microphone" style="color:#FFA500;"></i> ไมค์: <?= htmlspecialchars($room['microphone']) ?></p>
                            ...
                            <p><i class="fas fa-star"></i> คะแนนรีวิว: <?= number_format($room['avg_rating'], 1) ?>/5</p>
                            <p><i class="fas fa-comment"></i> รีวิวทั้งหมด: <?= $room['total_reviews'] ?></p>
                        </div>
...
<div id="reviews-container" style="display: none;">
   <?php foreach ($room_reviews as $review) : ?>
    <div class="review">
    <img src="images/like-comment.png" alt="User Icon" style="width: 30px; height: 30px; vertical-align: middle;">
        <p><i class="fas fa-user"></i> <strong><?php echo htmlspecialchars($review['username']); ?></strong></p>
        <p><i class="fas fa-comment"></i> <?php echo htmlspecialchars($review['comment']); ?></p>
        <p><i class="fas fa-star"></i> ให้คะแนน: <?php echo $review['rating']; ?> </p>
        <p><i class="fas fa-calendar-alt"></i> วันที่รีวิว: <?php echo $review['review_date']; ?></p>
    </div>
    <hr> <!-- เส้นขีดคั่นระหว่างรีวิว -->
<?php endforeach; ?>
